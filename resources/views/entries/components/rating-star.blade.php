...
<div class="fi-in-entry {{ $inline ? 'fi-in-entry-has-inline-label' : '' }}">
    <div class="fi-in-entry-label-col">
        <dt class="fi-in-entry-label">
            {{ $label }}
        </dt>
    </div>
    <div class="fi-in-entry-content-col" dir="{{ $direction }}">
        <dd class="fi-in-entry-content-ctn fi-in-entry-rating">
